...
export async function loadFriendRequests() {
    ...
    try {
        ...
        data.friendRequests.forEach((request: any) => {
...
export function displayFriendRequest(request: any) {
...
export async function respondToFriendRequest(requestId: string, status: string, socket: any) {
