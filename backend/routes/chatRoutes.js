...
const { fetchMessages, fetchChatHistory, fetchChatRooms,sendMessage, getMessages } = require('../controllers/chatController');
const router = express.Router();

router.post('/send', sendMessage);
router.get('/:roomId/messages', getMessages);
router.get('/rooms/:roomId/messages',fetchMessages);
router.get('/chatHistory/:roomId',fetchChatHistory);
